 ...
 * highlight the important factors (what drives it / how to play it / the main
 * caveat — folded here from the old transmission "why" section).
 *
...
export function ViewDescription({
  ...
  if (!hasDescription && safeBullets.length === 0) return null;
