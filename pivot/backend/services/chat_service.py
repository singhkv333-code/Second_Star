                ...
                if guarded.success:
                    ...
                    if (guarded.name == "screen_fundamentals"
                        ...
                        tool_msg_content += (
                            ...
                            "plain paragraphs. For a screen-shaped ask "
                            "the full ranked table is mandatory; for a "
                            "broader analysis include whichever grounding "
                            "tables serve the argument. If the user named "
