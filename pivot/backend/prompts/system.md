<!-- ⚠️ RETIRED 2026-07-03 — NOT LOADED AT RUNTIME. This monolith was split
     into `system_core.md` (always-on) + `modules/*.md` (per-intent packs,
     router-injected). Kept only as a git-history reference and last-ditch
     loader fallback. EDIT system_core.md or the relevant module instead —
