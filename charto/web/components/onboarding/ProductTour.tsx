...
const STEPS: TourStep[] = [
  ...
  },
  {
    ...
    description:
      "<strong>Home</strong> gives you the market at a glance, <strong>Chat</strong> is where you ask questions, and <strong>Portfolio</strong> holds your positions. We'll walk through the next two.",
  },
    {
    tab: "agents",
